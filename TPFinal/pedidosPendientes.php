...
$sqlPedidos="SELECT p.*,u.nombre,u.apellido FROM pedido p
INNER JOIN cliente c ON c.idcliente=p.idcliente_cliente
INNER JOIN usuario u ON u.idusuario=c.idusuario_usuario
 WHERE p.estado=0";// tengo que recuperar todos los pedidos que no esten activados
...
if (!$resultadoPedidos) {
  ...
  $tablaPedidos="<h1 align='center'>Lista de pedidos para aprobar</h1><table border='0' class='table table-striped'>";
  ...
  foreach ($datosPedidos as $pedido) {
    ...
    "<br><b>Estado de aceptacion:".$pedido['estado']."  </b><br><h3>Cliente:  </h3>Nombre: ".$pedido['nombre']." ".$pedido['apellido'] ."<br><h3>Productos del pedido</h3>";
     ...
     $tablaPedidos.="<br><a href='aceptarPedido.php?idPedido=".$pedido['idpedido'].
     "' class='btn btn-default'>Aceptar pedido</a><br>";
   ...
   <div class="col-lg-12">
     ...
     <div class="container-fluid">
       ...
       <ul class="nav navbar-nav">
         ...
         <li class="active"><a href="pedidosPendientes.php">Pedidos pendientes</a></li>
